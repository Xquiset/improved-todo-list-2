    ...
    <v-app>
        <v-container class="d-flex justify-center fill-height align-center">
            <v-card :width="width" rounded>
                ...
                <!-- Login form actions -->
                <v-card-actions>
                    <v-btn class="mr-2" color="primary" dark @click="submit">
                        Login
                    </v-btn>
                    <v-btn :href="this.$route('register')">
                        Register
                    </v-btn>
                </v-card-actions>
            </v-card>
